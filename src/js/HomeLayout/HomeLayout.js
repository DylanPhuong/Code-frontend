...
// const GAUGE_ARC_COLOR = 'rgba(207, 162, 56, 1)'; // màu của 2 cung tròn
...
//     const paperBg = isNormal ? '#54d65bff' : '#e02c2cff';  // << NỀN ĐẬM
//     const paperBorder = isNormal ? '#0b9b2fff' : '#000000ff';  // << VIỀN ĐẬM
...
//                 <Box>
//                     <Typography variant="h6" sx={{ fontWeight: 700, letterSpacing: 1, color: 'text.primary' }}>
//                         DASHBOARD
//                     </Typography>
...
// === Bạn chỉ cần đổi 2 hằng số này để chỉnh 2 cung tròn (độc lập nền Status) ===
const GAUGE_ARC_COLOR = 'rgba(207, 162, 56, 1)';
const GAUGE_ARC_WIDTH = 10;
// ==============================================================================
...
const GaugeMini = ({ value, unit, channel, name, status }) => {
    ...
    // NỀN THEO STATUS (đậm): Normal = xanh, còn lại = đỏ
    const isNormal = status === 'Normal';
    const paperBg = isNormal ? '#54d65bff' : '#e02c2cff';
    const paperBorder = isNormal ? '#0b9b2fff' : '#000000ff';
